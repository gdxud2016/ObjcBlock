...
- (void)viewDidLoad {
    ...
    [self.label gd_addObserverWithEventCallBackBlock:^(UIView *touchView) {
    ...
    [view22 gd_addObserverWithEventCallBackBlock:^(UIView *touchView) {
        [self.navigationController pushViewController:[[BackViewController alloc] init] animated:YES];
    }];
    ...
    [image gd_addObserverWithEventCallBackBlock:^(UIView *touchView) {
